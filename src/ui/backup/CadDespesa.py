...
################################################################################
## Form generated from reading UI file 'CadDespesa.ui'
##
...
class Ui_CadDespesa(object):
    def setupUi(self, CadDespesa):
        if not CadDespesa.objectName():
            CadDespesa.setObjectName(u"CadDespesa")
        CadDespesa.resize(405, 543)
        CadDespesa.setStyleSheet(u"font: 12pt \"Segoe UI\";")
        CadDespesa.setModal(True)
        self.frame_2 = QFrame(CadDespesa)
        ...
        self.frame_3 = QFrame(CadDespesa)
        ...
        self.tabWidget = QTabWidget(CadDespesa)
        self.tabWidget.setObjectName(u"tabWidget")
        self.tabWidget.setGeometry(QRect(0, 40, 411, 441))
        self.tab_3 = QWidget()
    ...
    def retranslateUi(self, CadDespesa):
        CadDespesa.setWindowTitle(QCoreApplication.translate("CadDespesa", u"Cadastro de Despesa", None))
        self.pushButton.setText(QCoreApplication.translate("CadDespesa", u"&Alterar", None))
        self.pushButton_2.setText(QCoreApplication.translate("CadDespesa", u"&Salvar", None))
        self.pushButton_3.setText(QCoreApplication.translate("CadDespesa", u"&Incluir", None))
        self.pushButton_4.setText(QCoreApplication.translate("CadDespesa", u"&Cancelar", None))
        self.label_21.setText(QCoreApplication.translate("CadDespesa", u"Descri\u00e7\u00e3o :", None))
        self.label_20.setText(QCoreApplication.translate("CadDespesa", u"Valor:", None))
        self.label_3.setText(QCoreApplication.translate("CadDespesa", u"R$", None))
        ...
        self.label_15.setText(QCoreApplication.translate("CadDespesa", u"Per\u00edodo em Meses :", None))
        self.label_17.setText(QCoreApplication.translate("CadDespesa", u"Origem da Despesa:", None))
        self.label_18.setText(QCoreApplication.translate("CadDespesa", u"Conta D\u00e9bito :", None))
        self.label_23.setText(QCoreApplication.translate("CadDespesa", u"Observa\u00e7\u00f5es", None))
        self.textEdit.setDocumentTitle("")
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QCoreApplication.translate("CadDespesa", u"Dados Principais", None))
        self.groupBox.setTitle(QCoreApplication.translate("CadDespesa", u"Fornecedor", None))
        self.label.setText(QCoreApplication.translate("CadDespesa", u"C\u00f3digo", None))
        self.label_2.setText(QCoreApplication.translate("CadDespesa", u"Nome :", None))
        self.pushButton_5.setText(QCoreApplication.translate("CadDespesa", u"p", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), QCoreApplication.translate("CadDespesa", u"Dados Adicionais ", None))
    # retranslateUi
