...
"}")
    ...
    def retranslateUi(self, booting_system):
        ...
        self.label_title.setText(QCoreApplication.translate("booting_system", u"<strong>Inicializando</strong> My Finance", None))
        self.label_description.setText(QCoreApplication.translate("booting_system", u"<strong>Sistema</strong> de Gerenciamento Financeiro", None))
