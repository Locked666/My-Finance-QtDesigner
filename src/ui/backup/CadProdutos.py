...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.groupBox.setGeometry(QRect(400, 90, 456, 222))
        self.groupBox.setMaximumSize(QSize(456, 222))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_17.setText(QCoreApplication.translate("Dialog", u"*SubGrupo :", None))
