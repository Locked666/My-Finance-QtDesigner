...
class Ui_Login(object):
    def setupUi(self, Login):
        ...
        Login.setMinimumSize(QSize(350, 448))
        Login.setMaximumSize(QSize(350, 448))
        Login.setAutoFillBackground(False)
        Login.setStyleSheet(u" border-top: none;")
        self.actionteste = QAction(Login)
...
"")
    ...
    def retranslateUi(self, Login):
        Login.setWindowTitle(QCoreApplication.translate("Login", u"My Finance - Login", None))
        self.actionteste.setText(QCoreApplication.translate("Login", u"teste", None))
#if QT_CONFIG(tooltip)
        self.actionteste.setToolTip(QCoreApplication.translate("Login", u"<html><head/><body><p>Login</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.Mainframe.setToolTip(QCoreApplication.translate("Login", u"<html><head/><body><p>teste</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
